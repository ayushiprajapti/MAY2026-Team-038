      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            {/* Profile Dropdown / Sign In Component */}
            {user ? (
              ...
              <Link
                to="/login"
                className="px-5 py-2 md:py-2.5 border border-heritage-red text-heritage-red hover:bg-heritage-red hover:text-white rounded text-sm font-semibold transition-all duration-300 font-sans shadow-sm"
              >
                Sign In
              </Link>
            )}
            ...
            {user ? (
              ...
              <div className="flex flex-col gap-2 pt-2">
                <Link
                  to="/login"
                  onClick={() => setIsOpen(false)}
                  className="w-full text-center py-2.5 bg-heritage-red text-white font-sans text-sm font-semibold rounded shadow-sm"
                >
                  Sign In
                </Link>
                <Link
                  to="/register"
                  onClick={() => setIsOpen(false)}
                  className="w-full text-center py-2.5 border border-heritage-red text-heritage-red hover:bg-heritage-red/5 font-sans text-sm font-semibold rounded"
                >
                  Register
                </Link>
              </div>
