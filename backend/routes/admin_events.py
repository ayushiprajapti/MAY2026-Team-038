...
def list_event_registrants(
    ...
    return event_service.list_event_registrants(conn, event_id)
...
def update_event(
    ...
    return event_service.update_event(conn, event_id, payload)
...
def delete_event(
    ...
    """
    event_service.delete_event(conn, event_id)
